...
function SmartMaintenance_option_page()
{
    ...
    $smSettings['pageTitle'] = "Coming Soon Page";	$smSettings['upload_logo'] = "";			$smSettings['upload_background'] = "";	
...
//DEFAULT VARIABLES
    if (isset($_POST['SaveSettings'])) {
        ...
        $smSettings['pageTitle'] = trim($_POST['pageTitle']);				$smSettings['upload_logo'] = trim($_POST['upload_logo']);				$smSettings['upload_background'] = trim($_POST['upload_background']);
...
/*        $timestamp = mktime( $smSettings['hour'], $smSettings['minute'], 0, $months[$smSettings['month']], $smSettings['day'], $smSettings['year'] );
    ...
    if($chk == true){
        $smSettings['pageTitle'] = $chk['pageTitle'];				        $smSettings['upload_logo'] = $chk['upload_logo'];				$smSettings['upload_background'] = $chk['upload_background'];
    ...
    </tr>	<tr>    	<td>Logo </td>        <td>:</td>        <td colspan="5"><div id="upload_logo_thumb" class="wpss-file">';		if(isset($record->security_image) && $record->security_image !='') {        // $adminBody.='<img src="'.$record->security_image.'"  width="65"/>';		} else { 		$adminBody.='<img src="'.$smSettings['upload_logo'].'"  width="65"/>';		} 				 $adminBody.='</div><input id="upload_logo" type="text" size="36" name="upload_logo" value=\'' . $smSettings['upload_logo'] . '\' class="wpss_text wpss-file"  /><input id="upload_logo_button" type="button" value="Upload background" class="wpss-filebtn" /></td>    </tr>	<tr>    	<td>Background</td>        <td>:</td>        <td colspan="5"><div id="upload_background_thumb" class="wpss-file">';		if(isset($record->security_image) && $record->security_image !='') {         $adminBody.='<img src="'.$record->security_image.'"  width="65"/>';		} else { 		$adminBody.='<img src="'.$smSettings['upload_background'].'"  width="65"/>';		} 				 $adminBody.='</div><input id="upload_background" type="text" size="36" name="upload_background" value=\'' . $smSettings['upload_background'] . '\' class="wpss_text wpss-file"  /><input id="upload_background_button" type="button" value="Upload background" class="wpss-filebtn" /></td>    </tr>
	<tr>
    	<td>Company Name</td>
        <td>:</td>
